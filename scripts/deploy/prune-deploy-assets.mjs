...
const distTilesetsRoot = resolve(distRoot, 'assets/tilesets');
...
export function collectRuntimeTilesetAssets({
  mapDir = tiledRoot,
...
if (import.meta.url === pathToFileURL(process.argv[1]).href) {
  ...
  if (result.pruned) {
    console.log(`[prune-deploy-assets] copied ${result.copied.length} runtime tileset asset(s) into dist/`);
