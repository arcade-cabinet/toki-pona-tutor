    ...
    layers: {
        ...
        Objects: [
            { type: "SpawnPoint", name: "default", at: [7, 5] },
            {
                ...
                name: "jan-pona-tomo",
                at: [4, 5],
                props: { id: "piper", dialog_id: "piper_welcome" },
            },
            {
                type: "NPC",
                name: "jan-telo-well",
                at: [3, 8],
                props: { id: "wren", dialog_id: "wren_well_water" },
            },
            {
                type: "NPC",
                name: "jan-sewi",
                at: [10, 6],
                props: { id: "selby", dialog_id: "selby_starter_intro" },
            },
            {
                type: "NPC",
                name: "jan-poki-tomo",
                at: [3, 5],
                props: { id: "oren", dialog_id: "oren_ready" },
            },
            {
                type: "NPC",
                name: "jan-kili-tomo",
                at: [4, 8],
                props: { id: "fig", dialog_id: "fig_snack" },
            },
            {
                type: "Warp",
                name: "warp_east",
