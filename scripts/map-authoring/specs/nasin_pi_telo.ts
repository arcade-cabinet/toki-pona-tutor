...
export default defineMap({
  ...
  layers: {
    ...
    Encounters: [
      ...
      { rect: [14, 10, 6, 3], species: { jan_moli: 14, kon_moli: 14, telo_jaki: 14, kala_telo: 14, kala_luka: 14, kala_uta: 14, seli_moli: 6, akesi_suli: 4, akesi_sewi: 2 }, levelRange: [9, 13] },
    ],
  },
});
