...
export default defineMap({
  ...
  layers: {
    ...
    Encounters: [
      { rect: [6, 3, 4, 2], species: { jan_ike_lili: 20, jan_utala_lili: 18, soweli_musi: 18, soweli_kili: 14, soweli_jaki: 10, waso_pimeja: 10, soweli_anpa: 10 }, levelRange: [3, 5] },
      { rect: [14, 6, 5, 2], species: { jan_ike_lili: 18, jan_utala_lili: 22, jan_moli: 14, soweli_musi: 14, soweli_kili: 14, waso_toki: 10, soweli_kon: 8 }, levelRange: [4, 6] },
