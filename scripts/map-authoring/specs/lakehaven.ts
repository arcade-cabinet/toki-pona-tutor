/**
 * beat_04_lakehaven — lake village.
 *
...
function lakeVillageBase(): string[][] {
    ...
    // West entry causeway from highridge_pass.
    for (let x = 0; x <= 8; x++) {
        grid[5][x] = "d";
        grid[6][x] = "d";
        grid[7][x] = "d";
    ...
    // North causeway to frostvale's gated warp.
    for (let y = 0; y <= 6; y++) {
        grid[y][14] = "d";
        grid[y][15] = "d";
    }
...
export default defineMap({
    ...
    layers: {
        ...
        Objects: [
            { type: "SpawnPoint", name: "from_highridge_pass", at: [2, 6] },
            {
                type: "NPC",
                name: "jan-kala-lake",
                at: [5, 13],
                props: { id: "loren", dialog_id: "loren_lake_quest" },
            },
            {
                type: "NPC",
                name: "jan-olin-telo",
            ...
            },
            {
                ...
                name: "jan-sike-telo",
                at: [12, 8],
                props: { id: "tarn", dialog_id: "tarn_plaza" },
            },
            {
                type: "NPC",
                name: "jan-telo",
                at: [15, 8],
                props: { id: "marin", dialog_id: "marin_intro" },
            },
            {
                type: "Warp",
                name: "warp_north",
