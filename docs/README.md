...
| --------- | -------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Context   | current shipped state, doc map, glossary                       | `STATE.md`, `README.md`, `GLOSSARY.md`                                                                                                                    |
| Product   | game identity, journey, lore, writing, roadmap                 | `DESIGN.md`, `JOURNEY.md`, `LORE.md`, `WRITING_RULES.md`, `ROADMAP.md`                                                                                    |
