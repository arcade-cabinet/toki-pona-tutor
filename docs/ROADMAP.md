...
| 8 | Release Proof | Prove Pages, release artifacts, and debug APKs | 3 | 2 | 1 |
| 9 | Docs And QA | Keep docs honest and acceptance artifacts reviewable | 2 | 1 | 1 |
| 10 | V1 Polish | Finish audio, post-clear loop, and final product QA | 0 | 1 | 4 |
...
| T8-03 | Prove remote release chain end to end | 🟡 | Local contract tests exist; remote proof still required. |
| T8-04 | Keep CD on workflow_run consumption | 🟡 | Configured, but should be proven by a real release run. |
...
| T9-03 | Audit all non-roadmap docs after each feature phase | 🟡 | High-risk docs are guarded; full prose audit remains discipline work. |
...
| T10-04 | Final docs accuracy pass | ⬜ | Every current-state claim must be backed by code/config/test/workflow evidence. |
